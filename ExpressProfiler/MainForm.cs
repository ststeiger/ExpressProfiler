...
namespace ExpressProfiler
{
    public partial class MainForm : Form
    {
        ...
        private void InitColumns()
        {
            ...
            if (m_currentsettings.EventsColumns.StartTime) m_columns.Add(new PerfColumn { Caption = "Start time", Column = ProfilerEventColumns.StartTime, Width = 140, Format = "yyyy-MM-ddThh:mm:ss.ffff" });
            if (m_currentsettings.EventsColumns.EndTime) m_columns.Add(new PerfColumn { Caption = "End time", Column = ProfilerEventColumns.EndTime, Width = 140, Format = "yyyy-MM-ddThh:mm:ss.ffff" });
        ...
        private void StartProfiling()
        {
            try
            {
                ...
                m_Rdr.SetFilter(ProfilerEventColumns.ApplicationName, LogicalOperators.AND
